...
useEffect(() => {
    axios.get("https://moeenweb.herokuapp.com/api/answers")
        .then(response => {
...
function handleClick2(event) {
  event.preventDefault();
    axios({
        method: 'post',
        url: 'https://moeenweb.herokuapp.com/api/answers/add',
        data: nuwUser
    });
}
  function handle1(){
    axios({
      method: 'delete',
      url: "https://moeenweb.herokuapp.com/api/answers/delete/1"
    })}
